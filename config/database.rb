...
database_name = case Padrino.env
  when :development then 'gezzzi_development'
  when :production  then 'gezzzi_production'
  when :test        then 'gezzzi_test'
end
...
#     sessions:
#       default:
#         database: gezzzi_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: gezzzi_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: gezzzi_test
#         hosts:
#           - localhost:27017
#
#
